...
@section('inline-js')
    ...
    <script type="text/javascript">
        ...
        var current_membergroup_id = 0
        $('body').on('click', '.show_membergroup_member_modal', function (e) {
            current_membergroup_id = $(this).attr("data-id");
            $("#member_modal").modal();
            refreshMemberList()
        ...
        $('body').on('keyup', '.member_search_input', function (e) {
            ...
            $.ajax({
                ...
                data: {
                    search: search,
                    current_membergroup_id: current_membergroup_id,
                },
                method: "GET",
                success: function (data) {
        ...
        function attachMemberToCell(member_id) {
            $.ajax({
                url: '/admin/membergroup/' + current_membergroup_id + '/attach_member',
                data: {
                    member_id: member_id,
                },
                method: "POST",
        ...
        function refreshMemberList() {
            $.ajax({
                url: '/admin/membergroup/' + current_membergroup_id + '/get_member_list',
                data: {},
                method: "GET",
                success: function (data) {
                    var html = "";
        ...
        $('body').on('click', '.detach_member', function (e) {
            var id = $(this).attr("data-id");
            $.ajax({
                url: '/admin/membergroup/' + current_membergroup_id + '/detach_member',
                data: {
                    member_id: id
                },
                method: "POST",
